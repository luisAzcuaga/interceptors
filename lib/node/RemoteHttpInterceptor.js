...
var _chunkWLEQXJCLjs = require('./chunk-WLEQXJCL.js');


var _chunkWZT3UEASjs = require('./chunk-WZT3UEAS.js');
require('./chunk-3LFH2WCF.js');
require('./chunk-V3JB6OXO.js');
...
var RemoteHttpInterceptor = class extends _chunkAA4NWHDYjs.BatchInterceptor {
  constructor() {
    super({
      ...
      interceptors: [
        new (0, _chunkWLEQXJCLjs.ClientRequestInterceptor)(),
        new (0, _chunkWZT3UEASjs.XMLHttpRequestInterceptor)()
      ]
    });
  }
  setup() {
